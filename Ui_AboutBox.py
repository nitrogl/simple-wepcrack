...
class Ui_AboutBox(object):
    def setupUi(self, AboutBox):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/res/swepc_green_small.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        AboutBox.setWindowIcon(icon)
        AboutBox.setLocale(QtCore.QLocale(QtCore.QLocale.Italian, QtCore.QLocale.Italy))
        AboutBox.setSizeGripEnabled(True)
        self.gridLayout = QtGui.QGridLayout(AboutBox)
        self.gridLayout.setSizeConstraint(QtGui.QLayout.SetFixedSize)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.widget_2 = QtGui.QWidget(AboutBox)
        ...
        self.widgetLogo = QtGui.QWidget(self.widget_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelLogo = QtGui.QLabel(self.widgetLogo)
        ...
        self.labelTitles = QtGui.QLabel(self.widget_2)
        ...
        self.labelMessage = QtGui.QLabel(self.widget_2)
        ...
        self.labelMessage.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByMouse)
